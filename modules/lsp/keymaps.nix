...
in {
  ...
  plugins.lsp.keymaps.extra = [
    ...
    (mkKeymap "n" "<leader>lgd" "<cmd>Lspsaga goto_definition<cr>" "Definitions")
    (mkKeymap "n" "<leader>lr" "<cmd>Lspsaga rename ++project<cr>" "Rename")
    (mkKeymap "n" "<leader>lgt" "<cmd>Lspsaga goto_type_definition<cr>" "Type Definitions")
    (mkKeymap "n" "<leader>l." "<cmd>Lspsaga show_line_diagnostics<cr>" "Line Diagnostics")
    (mkKeymap "n" "<leader>lgpd" "<cmd>Lspsaga peek_definition<cr>" "Peek Definition")
    (mkKeymap "n" "<leader>lgpt" "<cmd>Lspsaga peek_type_definition<cr>" "Peek Type Definition")
    ...
    (mkKeymap "n" "<leader>lgD" "<cmd>:lua vim.lsp.buf.declaration()<cr>" "Declaration")
    (mkKeymap "n" "<leader>lgi" "<cmd>:lua vim.lsp.buf.implementation()<cr>" "Implementation")
    (mkKeymap "n" "<leader>lgr" "<cmd>:lua vim.lsp.buf.references()<cr>" "References")
    (mkKeymap "n" "<leader>lgy" "<cmd>:lua vim.lsp.buf.type_definition()<cr>" "Type Definition")
